...
#################方法1##############
dots=[]
dots=np.linspace(0,3500,num=100,endpoint=False, dtype = int)
#print (dots)
...
for i in range(nrows):
    ...
    y_CA.append(CA[i])
    y_PH.append(PH[i])
    ax1.plot(x,y_NA,'.',color='#1A6FDF')
    ax2.plot(x,y_K,'.',color='#F14040')  
    ax3.plot(x,y_CA,'.',color='#FB6501')  
    ax4.plot(x,y_PH,'.',color='#9900FF') 
    plt.pause(0.01)
#################方法2##############
'''
plt.ioff()
